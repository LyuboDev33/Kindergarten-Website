...
<img class="blogHeadPart" src="../../images/headerDevelopment.jpg" alt="header">
...
$(document).ready(function () {
  ...
  $.ajax({
    ...
    type: "GET",
    url: "./ajaxBlog/getDevelopment.php",
...
<?php require "../dashboard/footerBLog.php"; ?>
